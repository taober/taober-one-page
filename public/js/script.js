...
(function($, window, document, undefined) {
    ...
    // init cubeportfolio
    $('#js-grid-plantas').cubeportfolio({
        filters: '#js-filters-plantas',
    ...
    $('#js-grid-imagens').cubeportfolio({
        //filters: '#js-filters-imagens',
        layoutMode: 'mosaic',
        sortByDimension: true,
        mediaQueries: [{
            width: 1500,
    ...
    $('#js-grid-imagens-mobile').owlCarousel({
        loop: true,
        smartSpeed: 500,
        responsiveClass: true,
        nav:false,
    ...
    $('#js-grid-plantas-mobile').owlCarousel({
        loop: true,
        smartSpeed: 500,
        responsiveClass: true,
        nav:false,
