...
Route::get('/admin', [App\Http\Controllers\DashboardController::class, 'index'])->name('admin');
    ...
    Route::get('/admin/taober/re-cache', [App\Http\Controllers\ImoveisController::class, 're_cache_image'])->name('re_cache_image');
    ...
    Route::get('/admin/nodes/lista/{tipo}', [App\Http\Controllers\AdmNodesController::class, 'index'])->name('index');
    Route::get('/admin/nodes/novo/{tipo}', [App\Http\Controllers\AdmNodesController::class, 'novo'])->name('novo');
